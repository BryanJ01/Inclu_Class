...
const NewActivityModal: React.FC<NewActivityModalProps> = ({ isOpen, onClose, onActivityCreated }) => {
  const { user } = useAuth();
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Explicación Paso a Paso (mínimo 10 caracteres)
              </label>
              <textarea
                name="explanation"
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Si no proporcionas una imagen, se usará una imagen predeterminada según la materia.
              </p>
            </div>
